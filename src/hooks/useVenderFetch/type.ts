...
export type UseVenderFetchType = (
  params: Params,
  token: {
    method: string;
    url: string;
...
) => UseQueryResult<GetVenReturn, ErrorType>;

export type VenGetType = (
  context: QueryFunctionContext<
    [string, Params, { method: string; url: string }]
  >
) => Promise<SuccessType<GetVenReturn>>;

// get vender return data type
export type GetVenReturn = {
  id: string;
  name: string;
  phone: string;
  address: string;
